<?php
    ...
    $sumNotas = round($sumNotas / count($avaliacoes));
    ...
    <div>
        <?php if (auth()): ?>
            <div class=" border border-stone-700 rounded">
                ...
                <form action="/avaliacao-criar" class="p-4 space-y-4" method="POST">
                    ...
                    <div class="flex flex-col">
                        ...
                        <label for="" class="text-stone-400 mb-1">Avaliação</label>
                        <textarea type="text" name="avaliacao" class="border-stone-800 border-2 rounded-md bg-stone-900 text-sm focus:outline-nome px-2 py-1"></textarea>
                    </div>
                    <div class="flex flex-col">
                        <label for="" class="text-stone-400 mb-1">Nota</label>
                        <select name="nota" class="border-stone-800 border-2 rounded-md bg-stone-900 text-sm focus:outline-nome px-2 py-1">
